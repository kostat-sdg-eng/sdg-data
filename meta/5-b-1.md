...
indicator_definition: >-
  이동(휴대) 전화를 소유한 개인이 차지하는 비율로 여기에서 이동(휴대)전화는 이동하면서 전화를 걸거나 받을 수 있게 하는 기기를 의미함. 
  스마트폰은 현재 일반폰(피쳐폰)보다 더 발달된 기능과 연결을 제공하고 이동전화에 포함되며, 
  모바일기기는 스마트폰, 태블릿, 웨어러블디바이스를 포함
